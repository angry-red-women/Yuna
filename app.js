...
function barfSupplementsPlan() {
  const days = [
    ['Montag', 'Jod'],
    ['Dienstag', '1 ml Lebertran'],
    ['Mittwoch', 'Jod'],
    ['Donnerstag', '–'],
    ['Freitag', '–'],
    ['Samstag', '1 ml Lebertran + Jod'],
    ['Sonntag', '–']
  ];
  const rows = days.map(([day, morning]) => `<div class="supplement-day" role="row"><b role="rowheader">${day}</b><span role="cell">${morning}</span><span role="cell">2 ml 3-6-9-Öl</span></div>`).join('');
