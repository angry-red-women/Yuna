...
const initial = {
  ...
  barfSource: 'Brigitte Erni', travelFoodAmount: '', foodTimes: '',
  travelFoodProduct: 'Amanova Delicious Lamb & Pumpkin – Köstliches Lamm mit Kürbis',
  travelFoodShop: 'TIER IM MITTELPUNKT',
  travelFoodUrl: 'https://tier-im-mittelpunkt.ch/products/amanova-delicious-lamb-pumpkin-koestliches-lamm-mit-kuerbis?variant=55161142083961',
...
const fields = [
  ...
  ['reminder', 'Nächster Termin gemäss Tierarzt', 'date'], ['barfAmount', 'BARF pro Mahlzeit'], ['barfSource', 'BARF-Bezugsquelle'],
...
const fieldGroups = {
  ...
  food: { title: 'Futter ändern', keys: ['barfAmount', 'barfSource', 'travelFoodAmount', 'travelFoodProduct', 'travelFoodShop', 'travelFoodUrl', 'foodTimes'] },
